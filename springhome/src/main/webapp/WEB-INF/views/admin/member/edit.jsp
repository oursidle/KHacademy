...
<form action="edit" method="post">
	<input type="hidden" name="memberId" value="${memberDto.memberId}">
		...
		주소
			<input type="text" name="memberPost" value="${memberDto.memberPost}" placeholder="우편번호" size="6" maxlength="6"> <br>
			<input type="text" name="memberAddr1" value="${memberDto.memberAddr1}" placeholder="기본주소"> <br>		
			<input type="text" name="memberAddr2" value="${memberDto.memberAddr2}" placeholder="상세주소"> <br><br>
		...
		등급
			<c:choose>
				...
				<c:when test="${memberDto.memberLevel == '관리자'}">
					...
					<input type="radio" name="memberLevel" value="관리자" checked> 관리자 <br><br>
				</c:when>
				<c:otherwise>
					<input type="radio" name="memberLevel" value="일반"> 일반
					<input type="radio" name="memberLevel" value="VIP" checked> VIP
