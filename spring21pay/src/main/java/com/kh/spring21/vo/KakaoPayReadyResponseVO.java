...
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)//(+추가) SNAKE_CASE를 CAMEL_CASE로 처리하도록 추가 도구를 설정
//@JsonIgnoreProperites({"tms_result"})//특정 항목만 무시하도록 지정
@JsonIgnoreProperties(ignoreUnknown = true)//모로는 항목은 무시하도록 지정
