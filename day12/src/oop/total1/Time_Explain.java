...
public class Time_Explain {
	//필드 - 시간을 초로 저장할 수 있는 필드로 1개만 구현
	private long value;
	...
	public Time_Explain(long hour, long minute, long second) {
		long total = hour * 60 * 60 + minute * 60 + second;
		this.setValue(total);
	}
	//[2] 분 / 초를 설정할 수 있는 생성자
	public Time_Explain(long minute, long second) {
		long total = minute * 60 + second;
		this.setValue(total);
	}
	//[3] 초를 설정할 수 있는 생성자
	public Time_Explain(long second) {
